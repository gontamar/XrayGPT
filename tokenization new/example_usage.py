...
def main():
    """Demonstrate basic usage of the tokenizer manager."""
    ...
    # Using TokenizerManager class
    print(f"\nUsing TokenizerManager with {selected_tokenizer}:")
    print("-" * 40)
    ...
    print(f"Special tokens: {list(manager.get_special_tokens().keys())}")

...
def create_tokenizer_manager(config_path: str = "tokenizer_config.yaml") -> TokenizerManager:
    """Create and return a TokenizerManager instance."""
    return TokenizerManager(config_path)
...
def quick_tokenize(text: str, tokenizer_name: str = None, 
    ...
    Returns:
        Dict containing tokenization results
    """
    manager = TokenizerManager(config_path)

...
class EmbeddingManager:
    ...
    def _detect_embedding_type(self, config, model_name: str) -> str:
        ...
        Returns:
            embedding_type: Always returns 'bert'
        """
        # Always return BERT since we only support BERT embeddings
        return 'bert'
    
    def _create_embedding_model(self, embedding_type: str, config):
        """
        Create the appropriate embedding model based on type.
        Only supports BERT embeddings now.
        
        Args:
            embedding_type: Type of embedding (only 'bert' supported)
            config: Model configuration
            
        Returns:
            embedding_model: BERT embedding model instance
        """
        # Only BERT embeddings are supported
    ...
    def load_embedding_model(
        ...
        Args:
            tokenizer_name: Name of tokenizer configuration to use (only BERT supported)
